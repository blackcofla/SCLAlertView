...
- (instancetype)init
{
    return [self initWithFactor: 1.0f];
}
...
- (instancetype)initWithFactor:(CGFloat)factor
{
    ...
    {
        // Default values
        kCircleTopPosition = -12.0f*(factor*1.5);
        kCircleBackgroundTopPosition = -15.0f*(factor*1.5);
        kCircleHeight = 56.0f*factor;
        kCircleHeightBackground = 62.0f*factor;
        kActivityIndicatorHeight = 40.0f;
        kTitleTop = 24.0f*factor;
        kTitleHeight = 40.0f*factor;
        self.subTitleY = 70.0f*factor;
        self.subTitleHeight = 90.0f*factor;
        self.circleIconHeight = 20.0f*factor;
        self.windowWidth = 240.0f*factor;
        self.windowHeight = 178.0f*factor;
...
- (void)viewWillLayoutSubviews
{
    ...
    {
        // Text fields
        CGFloat y = (_labelTitle.text == nil) ? (kCircleHeight - 20.0f) : self.subTitleY;//74.0f;
